 ...
 * @author User
 */
public class JF_Fornecedor extends javax.swing.JFrame {

    DefaultTableModel tb;
    List<Fornecedor_Bean> fornecedores;

    /**
     * Creates new form Fornecedor_JF
     */
    public JF_Fornecedor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CNPJ", "CPF", "IE", "Telefone", "Email", "Chave"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(editBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF_Fornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JF_Fornecedor().setVisible(true);
            }
        });
    }
    ...
    private void preencherTabela() {
        ...
        for (Fornecedor_Bean f : fornecedores) {
            ...
            for (int x = 0; x < tb.getRowCount(); x++) {
                int chave = (int) tb.getValueAt(x, 7);
                if (f.getChave() == chave) {
                    contem = true;
                }
            }
            if (!contem) {
                Object[] dado = {f.getId(), f.getNome(), f.getCnpj(), f.getCpf(),f.getIe(), f.getTelefone(), f.getEmail(), f.getChave()};
                tb.addRow(dado);
            }
        }
    }
    ...
    private void novo() {
        JD_NovoFornecedor jd = new JD_NovoFornecedor(this, true);
        jd.setVisible(true);
        preencherTabela();
    }
    ...
    private void editar() {
        for (Fornecedor_Bean f : fornecedores) {
            if ((int)jTable1.getValueAt(jTable1.getSelectedRow(), 0) == f.getId()) {
                JD_EditarFornecedor jd = new JD_EditarFornecedor(this, true , f);
                jd.setVisible(true);
                break;
            }
        }
